            ...
            <div>
                {
                    ...
                    :
                        (
                            <div>
                                {
                                    this.props.managersNotAssignedDistrict.length<=0
                                    ?
                                        (
                                            <Typography style={{color:red[500]}}>There is no registered district manager until now. Please register your district managers</Typography>
                                        )
                                    :
                                       (
                                           <div>
