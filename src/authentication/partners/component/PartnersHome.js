import { Avatar, Button, Card, CardActionArea, CardActions, CardContent, CardHeader, Chip, Container, Divider, Fab, Grid, Typography } from '@material-ui/core'
...
import auhtStyle from '../../styles/auth_style'
                            ...
                            <div>
                                {
                                    ...
                                    ?
                                        (
                                            <CompanyRegistration name={this.props.user.attribute.first_name}/>
                                        )
                                    :
                                        (
                                            <Posts/>
...
export default withStyles(authstyle)(connect(mapStateToProps,{me})(PartnersHome))